...
@section('title', 'Modifier Veterinaire')
...
<div class="page-content">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>Modifier veterinaire</span>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
        ...
        <div class="col-md-12">
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">Modifier Veterinaire</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body">
                    <form action="{{ route('veterinaire.update', ['id' => $veterinaire->id]) }}" class="form" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('nome') ? ' has-error' : '' }}">
                                    <label for="matricule">Nome</label>
                                    <input type="text" name="nome" class="form-control" placeholder="Nome" value="{{ $veterinaire->nom }}">
                                    @if ($errors->has('nome'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('telephone') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" name="telephone" class="form-control" placeholder="Telephone" value="{{ $veterinaire->tel }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <input type="email" name="email" class="form-control" placeholder="Email" value="{{ $veterinaire->email }}">
                                    @if ($errors->has('email'))
