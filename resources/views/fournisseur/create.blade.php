...
@section('title', 'Nouvelle Fournisseur')
...
<div class="page-content">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>Nouvelle Fournisseur</span>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
        ...
        <div class="col-md-12">
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">Ajouter nouveau Fournisseurs</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body">
                    <form action="{{ route('fournisseur.store') }}" class="form" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
